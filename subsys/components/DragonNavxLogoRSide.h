/*
 * DragonNavxLogoRSide.h
 *
 */

#ifndef SRC_SUBSYS_COMPONENTS_DRAGONNAVXLOGORSIDE_H_
#define SRC_SUBSYS_COMPONENTS_DRAGONNAVXLOGORSIDE_H_
...
class DragonNavXLogoRSide : public DragonNavX
{

	public:
		DragonNavXLogoRSide() = delete;
		DragonNavXLogoRSide
		(
		...
		virtual ~DragonNavXLogoRSide() = default;
...
#endif /* SRC_SUBSYS_COMPONENTS_DRAGONNAVXLOGORSIDE_H_ */
