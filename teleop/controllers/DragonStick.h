...
#ifndef SRC_TELEOP_CONTROLLERS_DRAGONSTICK_H_
#define SRC_TELEOP_CONTROLLERS_DRAGONSTICK_H_
...
class DragonStick: public IDragonController
{
	public:
		DragonStick() = delete;
		DragonStick( DragonStick* other ) =  delete;
		DragonStick
		(
...
#endif /* SRC_TELEOP_CONTROLLERS_DRAGONSTICK_H_ */
