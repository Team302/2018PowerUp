/*
 * DragonNavXLogoBack.h
 *
 */

#ifndef SRC_SUBSYS_COMPONENTS_DRAGONNAVXLOGOBACK_H_
#define SRC_SUBSYS_COMPONENTS_DRAGONNAVXLOGOBACK_H_

#include <subsys/components/DragonNavX.h>

#include <AHRS.h>

class DragonNavXLogoBack : public DragonNavX
{

	public:
		DragonNavXLogoBack() = delete;
		DragonNavXLogoBack
		(
		...
		virtual ~DragonNavXLogoBack() = default;
...
#endif /* SRC_SUBSYS_COMPONENTS_DRAGONNAVXLOGOBACK_H_ */
