/*
 * DragonNavXLogoLSide.h
 *
 */

#ifndef SRC_SUBSYS_COMPONENTS_DRAGONNAVXLOGOLSIDE_H_
#define SRC_SUBSYS_COMPONENTS_DRAGONNAVXLOGOLSIDE_H_
...
class DragonNavXLogoLSide : public DragonNavX
{

	public:
		DragonNavXLogoLSide() = delete;
		DragonNavXLogoLSide
		(
		...
		virtual ~DragonNavXLogoLSide() = default;
...
#endif /* SRC_SUBSYS_COMPONENTS_DRAGONNAVXLOGOLSIDE_H_ */
